...
2. The config object contains another value named **moveThreshold** (defaults to 5), which is used to avoid too sensitive move events when simply tap the screen.
